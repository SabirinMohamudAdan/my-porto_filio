...
const Header = () => {
  // ... (keep all your existing Header component code exactly the same) ...
};
...
const CVModal = ({ isOpen, onClose }) => {
  ...
  const docId = '11i9DSBU461E094-T5KI0aygJotPJgBig';
          ...
          {activeTab === 'preview' ? (
            <div className="h-[60vh] p-4">
              ...
              <p className="text-center text-gray-500 mt-2">
                Scroll to view the full CV. For best experience, download the file.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
